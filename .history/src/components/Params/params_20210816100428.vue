  ...
  <el-card class="box-card">
    ...
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
      <el-tab-pane label="静态参数" name="only">
        <el-button type="primary" @click="showaddCanShu()">添加参数</el-button>
        <!--表格-->
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button
            @click="showCanShuEditDia(scope.row)"
            size="small"
            plain
            type="primary"
            icon="el-icon-edit"
          ...
          ></el-button>
          <el-button
            @click="showCanShuDeleMsgBox(scope.row)"
            size="small"
            plain
            type="danger"
            icon="el-icon-delete"
    ...
    <!--添加商品参数弹窗-->
    <el-dialog title="添加商品参数" :visible.sync="dialogFormVisibleAdd">
    ...
    <el-form :model="edtForm">
      <!-- <el-form-item label="商品分类：" :label-width="formLabelWidth">
        <el-input v-model="edtForm.id" autocomplete="off"></el-input>
      </el-form-item> -->
      <el-form-item label="属性名称：" :label-width="formLabelWidth">
        <el-input
          v-model="edtForm.attr_name"
          autocomplete="off"
        ></el-input>
      </el-form-item>
      <el-form-item label="属性值：" :label-width="formLabelWidth">
        <el-input v-model="edtForm.attr_vals" autocomplete="off" placeholder="多个值用逗号隔开"></el-input>
      </el-form-item>
    </el-form>
    <div slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    async editCanShu(){
      ...
      const res = await this.$http.put(`categories/${this.edtForm.cat_id}/attributes/${this.edtForm.attr_id}`,this.edtForm)
      console.log(res)
    ...
    async addCanShu(){
      ...
      const res = await this.$http.post(`categories/${this.selectedOptions[2]}/attributes`,this.addForm)
      console.log(res)
