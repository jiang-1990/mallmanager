  ...
  <el-card class="box-card">
    ...
    <el-form :model="edtForm">
      <el-form-item label="省市区：" :label-width="formLabelWidth">
        <el-cascader :options="provces" clearable :props="default"></el-cascader>
      </el-form-item>
      <el-form-item label="详细地址：" :label-width="formLabelWidth">
        ...
        :rows="4"
        placeholder="请输入详细地址"
        v-model="edtForm.cat_name">
        </el-input>
      </el-form-item>
    </el-form>
    <div slot="footer" class="dialog-footer">
      <el-button @click="dialogFormVisibleEdt = false">取 消</el-button>
      <el-button type="primary" @click="edtAdress()">确 定</el-button>
    </div>
    </el-dialog>
  </el-card>
</template>
...
<script>
import prov from '@/assets/css/province'
export default {
  ...
  methods: {
    ...
    showEditGoodDia(row){
        this.provces=prov
        this.dialogFormVisibleEdt=true
        console.log(row)
    },
    //获取订单表格数据
    async getTableData(){
