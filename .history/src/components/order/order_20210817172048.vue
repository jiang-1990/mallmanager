<template>
  <el-card class="box-card">
    ...
    <el-table :data="tableData" style="width: 100%" height="500px">
      ...
      <el-table-column prop="order_id" label="订单编号" width="600">
      </el-table-column>
      <el-table-column prop="order_price" label="价格" width="100">
      </el-table-column>
      <el-table-column prop="goods_weight" label="是否付款" width="100">
      </el-table-column>
      <el-table-column prop="order_pay" label="是否发货" width="160">
      </el-table-column>
